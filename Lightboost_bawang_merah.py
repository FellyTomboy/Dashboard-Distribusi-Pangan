...
DATA_PATH = "bawang merah\\training\\data_model_bawang_merah.csv"
...
MODEL_SAVE_PATH = "bawang merah/training/model_bawang_merah.pkl"
...
test_predictions.to_csv(
    "training/bawang merah/test_predictions_bawang_merah.csv",
    index=False,
)
print(
...
val_predictions.to_csv(
    "training/bawang merah/val_predictions_bawang_merah.csv",
    index=False,
)
print(
...
test_metrics.to_csv(
    "training/bawang merah/test_metrics_bawang_merah.csv",
    index=False,
)
print(
    "Test metrics saved → "
